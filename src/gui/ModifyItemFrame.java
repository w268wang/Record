...
public class ModifyItemFrame extends JDialog implements ActionListener {
    ...
    private static final long serialVersionUID = 2572410149318899787L;
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(temp.compareTo(preIndex)!=0) {
			...
			if(temp.compareTo("")==0) {
				...
				if(selectedPerson.getLastname().compareTo("NULL")!=0)
					lastname.setText(selectedPerson.getLastname());
				else
					lastname.setText("");
				if(selectedPerson.getFirstname().compareTo("NULL")!=0)
					firstname.setText(selectedPerson.getFirstname());
				else
					firstname.setText("");
				if(selectedPerson.getAddress().getCity().compareTo("NULL")!=0)
					city.setText(selectedPerson.getAddress().getCity());
				else
					city.setText("");
				if(selectedPerson.getEMail().compareTo("NULL")!=0)
					eMail.setText(selectedPerson.getEMail());
				else
					eMail.setText("");
				if(selectedPerson.getPhoneNumber().getHomeNumber().compareTo("NULL")!=0)
					homePhone.setText(selectedPerson.getPhoneNumber().getHomeNumber());
				else
					homePhone.setText("");
				if(selectedPerson.getPhoneNumber().getWorkNumber().compareTo("NULL")!=0)
					workPhone.setText(selectedPerson.getPhoneNumber().getWorkNumber());
				else
					workPhone.setText("");
				if(selectedPerson.getPhoneNumber().getMobileNumber().compareTo("NULL")!=0)
					mobilePhone.setText(selectedPerson.getPhoneNumber().getMobileNumber());
				else
					mobilePhone.setText("");
				if(selectedPerson.getAddress().getAddr().compareTo("NULL")!=0)
					address.setText(selectedPerson.getAddress().getAddr());
				else
					address.setText("");
				if(selectedPerson.getResult().compareTo("NULL")!=0)
					result.setText(selectedPerson.getResult());
				else
					result.setText("");
				if(selectedPerson.getAddress().getNation().compareTo(DEFAULT_COUNTRY)==0) {
					Nation=DEFAULT_COUNTRY;
					ca.setSelected(true);
			        othercountry.setEditable(false);
			        ...
			        interIsSeleted = true;
			        othercountry.setText(selectedPerson.getAddress().getNation());
				}
				if(selectedPerson.getAddress().getProvince().compareTo("NULL")!=0)
					province.setSelectedItem(selectedPerson.getAddress().getProvince());
				else
					province.setSelectedItem("");
				if(selectedPerson.getDateOfBirth().getYear() > 1900)
					year.setText(""+selectedPerson.getDateOfBirth().getYear());
				else
					year.setText("");
				if(selectedPerson.getDateOfBirth().getMonth() > 0)
					month.setSelectedItem("" + selectedPerson.getDateOfBirth().getMonth());
				else
					month.setSelectedItem("");
				if(selectedPerson.getDateOfBirth().getDay() > 0)
					day.setSelectedItem("" + selectedPerson.getDateOfBirth().getDay());
				else
					day.setSelectedItem("");
			}
